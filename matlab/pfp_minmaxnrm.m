...
%
%       2. This function squash the value to 0 for any columns that have a tiny
%          range: i.e. mx - mn < 1e-8.
%
% Input
% -----
%   [double]
...
% Last modified: Fri 27 Feb 2015 04:49:21 PM EST
% }}}
    ...
    if ~all(mx >= mn)
        error('pfp_minmaxnrm:InputErr', ...
            'All specified MAX must not be smaller than MIN.');
    end
    % }}}
