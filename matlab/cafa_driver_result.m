function [] = cafa_driver_result(eval_dir, cfg, naive, blast, scheme)
%CAFA_DRIVER_RESULT CAFA driver result
% {{{
%
% [] = CAFA_DRIVER_RESULT(eval_dir, cfg, naive, blast, scheme);
%
...
% |     `-- <cfg>         (the configuation table, needs to be given)
