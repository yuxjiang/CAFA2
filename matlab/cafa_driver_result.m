...
% }}}
  ...
  if strcmp(mode, 'suppl') || strcmp(mode, 'all')
    ...
    [top10, baseline] = cafa_sel_top_seq_prcurve(10, prcurves, naive, blast, cfg, isdump);
    ...
    % [top10, baseline] = cafa_sel_top_seq_prcurve(10, prcurves, naive, blast, cfg, isdump, rmcurves);
  ...
  if strcmp(mode, 'all')
    ...
    cafa_sheet_seq_fmax(saveto_A, fmaxs, fmaxs_bst, cfg, isdump, true);
    cafa_sheet_seq_fmax(saveto_N, fmaxs, fmaxs_bst, cfg, isdump, false);
  end
  % }}}
  ...
  if strcmp(mode, 'all')
    ...
    rmcurves = cafa_collect(config.eval_dir, 'seq_rmcurve');
    [top10, baseline] = cafa_sel_top_seq_rmcurve(10, rmcurves, naive, blast, cfg, isdump);
  ...
  if strcmp(mode, 'all')
    ...
    cafa_sheet_seq_smin(saveto_A, smins, smins_bst, cfg, isdump, true);
    cafa_sheet_seq_smin(saveto_N, smins, smins_bst, cfg, isdump, false);
  end
  % }}}
  ...
  if strcmp(mode, 'paper') || strcmp(mode, 'suppl') || strcmp(mode, 'all')
    ...
    [top10, baseline, info] = cafa_sel_top_seq_fmax(10, fmaxs, naive, blast, cfg, isdump);
  ...
  if (strcmp(mode, 'paper') && (strcmp(config.cat, 'all') || strcmp(config.ont, 'hpo'))) ...
    ...
    [top10, baseline, info] = cafa_sel_top_seq_smin(10, smins, naive, blast, cfg, isdump);
  ...
  if strcmp(mode, 'all')
    ...
    if strcmp(config.ont, 'hpo')
      cafa_sheet_term_auc(saveto_A, aucs, cfg, isdump, true, 'BB4H');
      cafa_sheet_term_auc(saveto_N, aucs, cfg, isdump, false, 'BB4H');
    else % MFO, BPO, CCO
      cafa_sheet_term_auc(saveto_A, aucs, cfg, isdump, true, 'BB4S');
      cafa_sheet_term_auc(saveto_N, aucs, cfg, isdump, false, 'BB4S');
    end
  end
  % }}}
  ...
  if (strcmp(mode, 'paper') && (strcmp(config.cat, 'all') || strcmp(config.ont, 'hpo'))) ...
    ...
    aucs = cafa_collect(config.eval_dir, 'term_auc');
    [top10, baseline, info] = cafa_sel_top_term_auc(10, aucs, naive, blast, cfg, isdump);
    if isempty(top10)
