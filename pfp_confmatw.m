...
% Last modified: Thu 26 Feb 2015 10:45:54 PM EST
    ...
    validateattributes(pred, {'double'}, {'ncols', 1, '>=', 0, '<=', 1}, ...
        '', 'pred', 1);
    n = numel(pred);
    % }}}

    % check the 2nd input 'ref' {{{
    validateattributes(ref, {'logical'}, {'ncols', 1, 'numel', n}, ...
        '', 'ref', 2);
    % }}}
    ...
    validateattributes(tau, {'double'}, {'row', '>=', 0, '<=', 1}, ...
        '', 'tau', 4);
    k = numel(tau);
    % }}}
    % }}}

    cm = struct('TN', cell(1, k), 'FP', cell(1, k), ...
                'FN', cell(1, k), 'TP', cell(1, k));
